...
class HttpServerException extends Exception {
  ...
  /**
   * Renders this exception into an object
   * @returns {Object} - JSON represention of HttpServerException
   */
  toJSON() {
    return {
      // These keys are intentionally sorted out of order so they render a bit
 ...
 */
class ClientError extends HttpServerException {}
 ...
 * @memberof Koolaid.ErrorHandling.HttpExceptions
 */
class ServerError extends HttpServerException {}
